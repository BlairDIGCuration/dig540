<?php
  class Album{
    ...
    public function getGenres(){ print_r('Text_Cache: '.$this->genres. '<br>';)
//for($j=0; $j<co($this->genres); $j++){
           // if($j%2==0) print_r("<span style='color:blue'>Text_Cache #".($j+1)." is ".$this->genres[$j]."</span><br>");
           // else print_r("<span style='color:red'>Text_Cache #".($j+1)." is ".$this->genres[$j]."</span><br>");
        }
    }
